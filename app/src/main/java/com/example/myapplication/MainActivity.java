...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        usuarioLogueado = getIntent().getBooleanExtra("usuario_logueado", false);
        if (usuarioLogueado) {
            setContentView(R.layout.activity_listview_user); // Debes crear este layout
        } else {
                ...
                if (entrada != null) {
                    ...
                    miRadio.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            if (radioButton_pulsado == miRadio) {
                                miRadio.setChecked(false);
                                radioButton_pulsado = null;
                                texto.setText("NINGUNA OPCIÓN MARCADA");
                            } else {
                                ...
                                if (usuarioLogueado) {
                                    ...
                                    intent.putExtra("titulo", item.get_textoTitulo());
                                    intent.putExtra("contenido", item.get_textoContenido());
        ...
        if (usuarioLogueado) {
            ...
            if (btnLogout != null) {
                btnLogout.setOnClickListener(v -> {
                    ...
                    // Añade flags para vaciar la pila de Activities y evitar volver con 'atrás'
